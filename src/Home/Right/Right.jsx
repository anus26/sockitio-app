...
const Right = () => {
  ...
  <div className={`lg:block ${selectedChat ? "block":"hidden"} w-full  bg-blue-900 text-gray-300 flex  overflow-y-auto flex-col lg:w-[70%]`}   
                style={{ maxHeight: "calc(129vh - 10vh)" }}> 
      {!selectedChat ? <NoChat /> : (
        <>
          <Chatuser />
